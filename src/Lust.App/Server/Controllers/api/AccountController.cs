...
using Lust.App.Server.ViewModels.AccountViewModels;
        ...
        public async Task<IActionResult> Register([FromBody]RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                ...
                if (roleAddResult.Succeeded)
                {
                    ...
                    await _clienteAppService.RegistrarAsync(Guid.Parse(currentUser.Id), model.Nome, model.Email, model.Celular, model.Cpf, model.DataNascimento, model.Cep);
