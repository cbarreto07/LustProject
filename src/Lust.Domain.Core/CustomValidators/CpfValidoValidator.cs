...
{
    public class CpfValidoValidator : PropertyValidator, IPropertyValidator
    {
        readonly object defaultValueForType;

        public CpfValidoValidator(object defaultValueForType) : base(new LanguageStringSource(nameof(CpfValidoValidator)))
        {
        ...
        protected override bool IsValid(PropertyValidatorContext context)
        {
            ...
            var cpf = RemoveNaoNumericos(context.PropertyValue.ToString());
