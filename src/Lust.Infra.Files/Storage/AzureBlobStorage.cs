...
namespace Lust.Infra.Files.Storage
{
    public class AzureBlobStorage : IAzureBlobStorage
    {
        ...
        public async Task<MemoryStream> GetStreamAsync(string blobName)
        {
            //Blob
            CloudBlockBlob blockBlob = await GetBlockBlobAsync(blobName);
        ...
        {
            return new Uri($"https://{this.settings.StorageAccount}.blob.core.windows.net/{this.settings.ContainerName}/");
        }
